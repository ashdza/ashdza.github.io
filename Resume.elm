...
work =
    [ { role = "Backend Development Intern - Biglearn team"
      ...
      , details =
            ...
            [ "Created scalable application with testing & deployment automation to handle/record request info (RoR)"
            , "Developed regular & serverless Postgresql database setups for use in Biglearn (AWS, AWS Aurora)"
    ...
    , { role = "Teaching Assistant"
      ...
      , dates = "Fall 2019"
      , details =
            [ "TA for Reasoning about Algorithms: lead office hours and discussion of labs, grade homeworks"
            ]
      , links = []
      }
    -- , 
