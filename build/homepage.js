...
var _user$project$ResumeTypes$Resume = F2(
	function (a, b) {
		return {header: a, body: b};
	});
var _user$project$ResumeTypes$Header = F6(
	function (a, b, c, d, e, f) {
		return {name: a, affils: b, home: c, email: d, phone: e, links: f};
	});
var _user$project$ResumeTypes$Item = F6(
	function (a, b, c, d, e, f) {
		return {role: a, name: b, location: c, dates: d, details: e, links: f};
	});
var _user$project$ResumeTypes$FlatItem = F3(
	function (a, b, c) {
		return {name: a, attrs: b, links: c};
	});
var _user$project$ResumeTypes$Link = F2(
	function (a, b) {
		return {ctor: 'Link', _0: a, _1: b};
	});
var _user$project$ResumeTypes$Repo = function (a) {
	return {ctor: 'Repo', _0: a};
};
var _user$project$ResumeTypes$Demo = function (a) {
	return {ctor: 'Demo', _0: a};
};
var _user$project$ResumeTypes$More = function (a) {
	return {ctor: 'More', _0: a};
};
var _user$project$ResumeTypes$InlineSection = F2(
	function (a, b) {
		return {ctor: 'InlineSection', _0: a, _1: b};
	});
var _user$project$ResumeTypes$FlatSection = F2(
	function (a, b) {
		return {ctor: 'FlatSection', _0: a, _1: b};
	});
var _user$project$ResumeTypes$NestedSection = F2(
	function (a, b) {
...
var _user$project$ResumeView$bullet = A2(
	...
	{ctor: '[]'});
var _user$project$ResumeView$viewHeader = function (header) {
	var $short = function (url) {
		return A2(_elm_lang$core$String$dropLeft, 8, url);
	};
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('namePhoto'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('nameAffil'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('myName'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(header.name),
									_1: {ctor: '[]'}
								}),
							_1: A2(
								_elm_lang$core$List$map,
								function (affil) {
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('affil'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(affil),
											_1: {ctor: '[]'}
										});
								},
								header.affils)
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('myContactInfo'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(header.email),
									_1: {
										ctor: '::',
										_0: _user$project$ResumeView$bullet,
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text(header.phone),
											_1: {ctor: '[]'}
										}
									}
								}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('urls'),
									_1: {ctor: '[]'}
								},
								A2(
...
var _user$project$ResumeView$viewInlineSection = F2(
	function (name, items) {
		return A2(
			_elm_lang$html$Html$section,
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('bulletSepList'),
							_1: {ctor: '[]'}
						},
						A2(
							_elm_lang$core$List$map,
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('itemLeft'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('itemRole'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$span,
										{ctor: '[]'},
										A2(_elm_lang$core$List$map, _user$project$ResumeView$viewLink, links)),
									_1: {ctor: '[]'}
								}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('itemDetails'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$List$map,
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('itemAttrs'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('itemDates'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(dates),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('itemLocation'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$ResumeView$viewNestedSection = F2(
	function (name, items) {
		return A2(
			_elm_lang$html$Html$section,
			{ctor: '[]'},
...
var _user$project$ResumeView$viewFlatSection = F2(
	function (name, items) {
		return A2(
			_elm_lang$html$Html$section,
			{ctor: '[]'},
						...
						A2(
							...
							function (_p5) {
								...
								return A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('split-l-r'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _user$project$ResumeView$view = function (model) {
	return A2(
		...
		A2(
			...
			A2(_elm_lang$core$List$map, _user$project$ResumeView$viewSection, model.body)));
};
var _user$project$ResumeView$nullHtml = A3(
...
var _user$project$Demos$demosNestedSections = function (resume) {
	...
	return A2(_elm_lang$core$List$concatMap, demoItems, resume.body);
};
...
var _user$project$Resume$activities = {
	ctor: '::',
	_0: A3(
...
var _user$project$Resume$projects = {
	...
	_0: {
		...
		links: {
			ctor: '::',
			_0: _user$project$ResumeTypes$Repo('https://github.com/ashdza/lentil'),
			_1: {
				ctor: '::',
				_0: _user$project$ResumeTypes$Demo('https://lentil.7insights.com/'),
				_1: {ctor: '[]'}
			}
		}
	},
...
var _user$project$Resume$work = {
	...
	_0: {
		...
		details: {
			...
			_1: {
				ctor: '::',
				_0: 'Developed backend Java application to connect business development team to startup customers',
				_1: {
					ctor: '::',
					_0: 'Designed & deployed multiple APIs and clients with unit, integration & acceptance tests',
					_1: {
						ctor: '::',
						_0: 'Developed databases by defining schema, data access objects & automated jobs using SQL and Java',
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Resume$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	_user$project$ResumeView$view(_user$project$Resume$theResume));
...
var _user$project$HomePage$blogUrl = 'https://ashdza.github.io/blog/';
		...
		if (_p0.ctor === 'NoOp') {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						mode: _user$project$Menu$update(_p0._0)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$HomePage$Model = F2(
	function (a, b) {
		return {mode: a, resume: b};
	});
var _user$project$HomePage$About = {ctor: 'About'};
var _user$project$HomePage$Blog = {ctor: 'Blog'};
var _user$project$HomePage$Demos = {ctor: 'Demos'};
var _user$project$HomePage$CV = {ctor: 'CV'};
var _user$project$HomePage$menu = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'Resume', _1: _user$project$HomePage$CV},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'Demos and Source', _1: _user$project$HomePage$Demos},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'Blog', _1: _user$project$HomePage$Blog},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'About', _1: _user$project$HomePage$About},
				_1: {ctor: '[]'}
			}
		}
	}
...
var _user$project$HomePage$init = {
	ctor: '_Tuple2',
	_0: {mode: _user$project$HomePage$CV, resume: _user$project$Resume$theResume},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$HomePage$NoOp = {ctor: 'NoOp'};
										...
										},
										{
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _user$project$ResumeView$sectionHeader('Blog'),
														_1: {
															ctor: '::',
															_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _user$project$ResumeView$sectionHeader('About'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
...
if (typeof _user$project$HomePage$main !== 'undefined') {
    _user$project$HomePage$main(Elm['HomePage'], 'HomePage', undefined);
}
